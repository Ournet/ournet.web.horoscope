                ...
                <div className='o-wrapper'>
                    <div className='o-layout'>
                        ...
                        <div className='o-layout__item u-1/3@tablet o-footer-sites'>
                            ...
                            {config.internationalIds.map(code => <div key={code}><a href={getSchema(config.project, code) + '//' + getHost(config.project, code) + links.horoscope.home({ ul: lang })}>{countryNames[code][lang]}</a></div>)}
                        </div>
